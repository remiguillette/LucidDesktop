...
const Desktop = () => {
  ...
  const desktopIcons = [
    ...
    { id: 'notepad', name: t('desktop.notepad'), icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 22h.5c.5 0 1-.2 1.4-.6.4-.4.6-.9.6-1.4V7.5L14.5 2H6c-.5 0-1 .2-1.4.6C4.2 3 4 3.5 4 4v1"/><path d="M14 2v6h6"/><path d="M4 12h12"/><path d="M4 16h12"/><path d="M4 20h12"/></svg>, app: Notepad }
  ];
